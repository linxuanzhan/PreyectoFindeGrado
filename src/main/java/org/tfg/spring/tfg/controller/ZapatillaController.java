...
public class ZapatillaController {
    ...
    @GetMapping("r")
    public String r(ModelMap m, @Param("PalabraClave") String palabraClave, HttpSession session) {
    ...
    @GetMapping("u")
    public String update(@RequestParam("id") Long idZapatilla, ModelMap m, HttpSession session) {
        Usuario usuario = (Usuario) session.getAttribute("usuario");
        if (usuario == null || !Boolean.TRUE.equals(usuario.getAdmin())) {
            return "redirect:/login";
        }
    ...
    @PostMapping("u")
    public String updatePost(@RequestParam("idZapatilla") Long idZapatilla,
    ...
    @PostMapping("d")
    public String delete(@RequestParam("id") Long idZapatilla, HttpSession session) throws DangerException {
        Usuario usuario = (Usuario) session.getAttribute("usuario");
        if (usuario == null || !Boolean.TRUE.equals(usuario.getAdmin())) {
            return "redirect:/login";
        }
